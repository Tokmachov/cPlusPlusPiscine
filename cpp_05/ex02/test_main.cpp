...
/*   Updated: 2021/02/10 15:10:18 by sjolynn          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string test1 = "Bureaucrat executes unsigned form";
std::string test2 = "Bereaucrat attemts to execute form of higher grade \
    (form is signed)";
std::string test3 = "Bureaucrat attemts to execute \
signed \"ShrubberyCreationForm\" with lower grade of form";
std::string test4 = "Bureaucrat attemts to execute \
signed \"RobotomyRequestForm\" with lower grade of form";
std::string test5 = "Bureaucrat attemts to execute \
signed \"PresidentialPardonForm\" with lower grade of form";
std::string test6 = "";
std::string test7 = "";
std::string test8 = "";
std::string test9 = "";
...
void testFunc4(void) {
    std::cout << "----Test-------------------------------------"  << std::endl;
    RobotomyRequestForm form("Process");
    Bureaucrat b("John", 44);
    form.beSigned(b); 
    b.executeForm(form);
}
